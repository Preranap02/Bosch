...
shipments_df = pd.read_csv('/home/zadmin/Supply_Chain/shipments.csv')
delivery_logs_df = pd.read_csv('/home/zadmin/Supply_Chain/inventory.csv')
claims_df = pd.read_csv('/home/zadmin/Supply_Chain/claims.csv')
vendors_df = pd.read_csv('/home/zadmin/Supply_Chain/vendors.csv')
inventory_df = pd.read_csv('/home/zadmin/Supply_Chain/inventory.csv')
...
delivery_logs_df['ship_date'] = pd.to_datetime(delivery_logs_df['ship_date'])
delivery_logs_df['delivery_date'] = pd.to_datetime(delivery_logs_df['delivery_date'])

# Create 'delivery_duration_days' column by subtracting dates
delivery_logs_df['delivery_duration_days'] = (delivery_logs_df['delivery_date'] - delivery_logs_df['ship_date']).dt.days

# Now you can fill missing values safely
